# Motorcycle.js Browserify Boilerplate

While this boilerplate is heavily inspired by [cycle-boilerplate](https://github.com/kahlil/cycle-browserify-boilerplate.git)
